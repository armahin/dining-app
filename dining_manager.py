...
def mark_boarder():
    """Mark boarder as eaten, used by both button and Enter key"""
...
# Text input with Enter key triggers the same function as button
st.text_input(
    "Enter Boarder Number:",
    key="boarder_input",
    on_change=mark_boarder
)

# Button triggers same function
